...
export const AGENT_VISUALS: Record<string, AgentVisual> = {
  ...
  // The four primary mascots keep clearly separated identity colors. These
  // values are deliberately distinct from Quinta's violet and Ma's amber;
  // the existing image/cosmetic identity remains unchanged.
  Livro:   { color: '#0891b2', marking: 'whistle',   clickAnim: 'fast',  quote: 'Consultando a enciclopédia esportiva. Futebol, NBA, NFL e MLB na ponta da língua!', imageUrl: '/avatars/livro.png', cosmetics: { head: 'signal_band', body: 'status_bar' } },
  Mosbey:  { color: '#0f766e', marking: 'none',      clickAnim: 'hop',   quote: 'Catálogo aberto. Qual filme entra agora?', cosmetics: { bodyShape: 'cloud' } },
